...
Afin de simplifier notre propos, nous consid\'ererons que le syst\`eme \`a inverser 
...
car elle est donn\'ee par la condition de Dirichlet ou p\'eriodique.
Si la syst\`eme dispose d'un nombre diff\'erent d'inconnues, on pourra
...
d\'ecentr\'e amont n'est stable que sous une certaine condition
