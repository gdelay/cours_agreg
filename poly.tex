...
%%%%%%%%%%%%%%%%%%
\subsubsection{Analyse de discr\'etisations}
...
ce qui explique les r\'esultats num\'eriques obtenus.
Nous proposerons \'egalement un sch\'ema stable.




!! Mettre les deux sch\'emas num\'eriques ensemble !!
!! motivation : on a eu l'impression que c'\'etait facile pour
le cas elliptique, montrons qu'ici tout n'est pas si simple !!



!! Autre sch\'ema num :

Approchons les d\'eriv\'ees par 
\begin{align}
