...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Recherche d'une solution faible}

!! IL VAUDRAIT PEUT-\^ETRE MIEUX METTRE CETTE SECTION DANS
LA SECTION BONUS HORS PROGRAMME !!


On prouve la proposition suivante.
\begin{proposition}
  Soit $f \in L^2(0,T;L^2(0,1))$ et $u_0 \in L^2(0,1)$.
  Alors il existe une unique solution $u$ dans 
