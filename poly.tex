...
On remarque que les fonctions de la forme $\sin(k \pi x) e^{-k^2 \pi^2 t}$
v\'erifient l'\'equation de la chaleur.
L'approche que nous allond pr\'esenter consiste donc \`a 
...
On suppose que la donn\'ee initiale est $C^0([0,1])$ avec $u_0(0) = u_0(1) = 0$
et \'egalement $C^1$ par morceaux.
On peut d\'ecomposer $u_0$ en s\'erie de Fourier (...)
...
!! sch\'ema explicite !! + exo: retrouver figures de l'intro !!
...
!! intro sch\'ema explicite centr\'e !!

!! initialisation du pas de temps 1 !!

!! exo : retrouver les r\'esultats de la section d'intro !! 

%%%%%%%%%%%%%%%%%
\subsubsection{D\'efinitions et th\'eor\`emes}

!! on adapte toutes les d\'efinitions pr\'ec\'edentes au cas des sch\'emas \`a deux pas !!
(est-ce que deux pas c'est suffisant ou bien faut-il pr\'evoir plus ??
