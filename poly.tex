...
!! EST-CE QU'ON PEUT AUGMENTER LA REGULARITE EN TEMPS ET EN EPACE DE LA SOLUTION ??
--- EN TEMPS C'EST COMPLIQU\'E A CAUSE DU SECOND MEMBRE, EN ESPACE CA DOIT ETRE BON
--- LE PROUVER !!!!

!! DIRE QUE LA PREUVE SE TROUVE EN SECTION \ref{subsec:chal_sol_faibles} !!
...
!! EST-CE QUE L'EFFET REGULARISANT EST SEULEMENT SANS $f$ ??
...
\begin{proposition}
  ...
  alors $u \in L^{\infty}(0,T;L^2(0,1))$ et
  \begin{align*}
...
\begin{proof}
  Montrons que $u \in L^{\infty}(0,T;L^2(0,1))$ (...)
  
  !! TODO !!
  
  Maintenant, multiplions la premi\`ere ligne de \eqref{eq:chaleur_Dir} par $u$
