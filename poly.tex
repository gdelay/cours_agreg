...
\begin{exercise}
  ...
  \item Observer que ce sch\'ema est instable si on ne respecte pas la condition de CFL:
    $c h_t \leq h_x$ (voir Th\'eor\`eme~\ref{thm:stab_ondes_exp}).
...
On a donc montr\'e le r\'esultat suivant.
\begin{theorem}
  \label{thm:stab_ondes_exp}
  Le sch\'ema~\eqref{eq:ondes_DF_exp} est stable en norme $\| \cdot \|_{L^2}$ si et seulement si la condition
  de CFL suivante est v\'erifi\'ee:
  \begin{align*}
    c h_t \leq h_x .
  \end{align*}
\end{theorem}
